            ...
            if 12 != pos_tipo != 13:
                ...
                if usuario == 0:
                    ...
                    if color == "R":
                        ...
                        imprimir_carta(c, jugador_tipo , (len(jugador_tipo)-1))
                    elif color == "AZ":
...
def accion_usuario(medio, color_usuario, numero_usuario, mazo, todos_los_colores, todos_los_tipos, cant_sumar, intento = 0):
    ...
    if accion == "T":
        ...
        if intento == 0:
            ...
            accion_usuario(pozo, usuario_color, usuario_tipo, matriz_mazo, colores, tipos, sumarcartas, 1)
